...
namespace Daedalic.ProductDatabase.Migrations
{
    ...
    [Migration("20200206164404_ReleaseGroups")]
    partial class ReleaseGroups
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Daedalic.ProductDatabase.Models.Engine", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Daedalic.ProductDatabase.Models.Release", b =>
                {
                    ...
                    b.Property<DateTime?>("ReadyForReleaseDate")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("Daedalic.ProductDatabase.Models.ReleaseGroup", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Daedalic.ProductDatabase.Models.ReleaseInReleaseGroup", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("ReleaseInReleaseGroup");
                });
            ...
            modelBuilder.Entity("Daedalic.ProductDatabase.Models.Release", b =>
                {
                    b.HasOne("Daedalic.ProductDatabase.Models.Engine", "Engine")
                        .WithMany("Releases")
                    ...
                    b.HasOne("Daedalic.ProductDatabase.Models.ReleaseStatus", "ReleaseStatus")
                        .WithMany("Releases")
            ...
            modelBuilder.Entity("Daedalic.ProductDatabase.Models.ReleaseInReleaseGroup", b =>
                {
                    b.HasOne("Daedalic.ProductDatabase.Models.ReleaseGroup", "ReleaseGroup")
                        .WithMany("Releases")
